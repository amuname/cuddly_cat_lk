...
export declare function useLazyQuery<TResult = any, TVariables extends Record<string, unknown> = any>(document: DocumentParameter<TResult, TVariables>, variables?: VariablesParameter<TVariables>, options?: OptionsParameter<TResult, TVariables>): {
    ...
    onResult: (fn: (param: import("@apollo/client/core").ApolloQueryResult<TResult>, context: import("./useQuery").OnResultContext) => void) => {
        off: () => void;
    };
    onError: (fn: (param: import("@apollo/client/errors").ApolloError, context: import("./useQuery").OnErrorContext) => void) => {
        off: () => void;
    };
};
